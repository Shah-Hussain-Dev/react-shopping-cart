            ...
            {cart.map((item) => {
              return (
                <Row className="justify-content-between" key={item.id}>
                  <div className="d-flex align-items-center  box-shadow   bg-light  py-3 justify-content-between w-100 selected-cart-card">
                    <img
                      src={item.thumbnail}
                      className="cart-details-image box-shadow"
                      alt={item.title}
                    />
                    <div className="d-flex flex-column ms-4  selected-cart-details">
                      ...
                      <p className="mb-0 py-1 bg-light">
                        <AiFillPlusCircle
                          onClick={() =>
                            dispatch({
                              type: "INCREASE_QTY",
                    ...
                    <MdDeleteForever
                      size={33}
                      className="pb-1 text-danger ms-2 delete-cart-icon"
                      onClick={() =>
        ...
        >
          <div className="px-2 py-3">
            ...
            <div className="d-flex  flex-column">
              <hr />
              <h4 className="text-primary title">Totals : ₹{total * 80}</h4>
              <hr />
    ...
    return (
      ...
      >
        <img
          ...
          width="400"
        />
        <h1 className="display-6 py-3 title">Your Cart is Empty </h1>
        <Link to="/">
          <Button>
            {" "}
